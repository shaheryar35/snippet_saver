defmodule SnippetSaverWeb.Router do
  use SnippetSaverWeb, :router

  import SnippetSaverWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {SnippetSaverWeb.Layouts, :root}
  ...
  scope "/", SnippetSaverWeb do
    ...
    live_session :app,
      ...
      live "/vendors/:id", VendorLive.Index, :show
      live "/vendors/:id/edit", VendorLive.Index, :edit
    end
  end

  # Other scopes may use custom stacks.
  # scope "/api", SnippetSaverWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:snippet_saver, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: SnippetSaverWeb.Telemetry
